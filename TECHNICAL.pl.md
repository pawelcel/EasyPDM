...
- **`db/migrations/`** — migracje `002`–`045` dla już istniejącej bazy: projekty, typy
  ...
  pliki, niezależne od drzewa plików samego klienta. Od migracji 027 pliki z tego folderu są wbudowane
