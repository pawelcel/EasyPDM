...
4. Prüft die **Custom Properties** des Hauptdokuments:
   ...
   - **Noch nicht verknüpft** — öffnet den System-Browser (bereits angemeldet,
     ...
     Normteil → Material/Norm; Kundenteil → Kunde + Name 2 (erst nach Auswahl eines Kunden); **eine Baugruppe hat
     eigene Arten** (Gefertigt; Zugekauft → Hersteller/Serie-Typ/Untertyp; Vom Kunden → Kunde + Name 2) plus eine
