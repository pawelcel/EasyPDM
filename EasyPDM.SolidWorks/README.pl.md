...
4. Sprawdza **Właściwości niestandardowe** dokumentu głównego:
   ...
   - **Jeszcze niepodpięty** — otwiera przeglądarkę systemową (już zalogowaną, most
     ...
     Klient + Nazwa 2 (dopiero po wybraniu Klienta); **Złożenie ma własne rodzaje** (Wykonywane; Zakupowe →
     Producent/Seria-Typ/Podtyp; Klienta → Klient + Nazwa 2) plus zawsze opcjonalną Masę — plus
